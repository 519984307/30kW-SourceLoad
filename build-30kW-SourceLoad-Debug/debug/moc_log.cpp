...
QT_MOC_LITERAL(1, 4, 13), // "logFileFormat"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 10) // "FILEFORMAT"

    },
    "Log\0logFileFormat\0\0FILEFORMAT"
};
...
void Log::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Log::*_t)(FILEFORMAT );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Log::logFileFormat)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Log::logFileFormat(FILEFORMAT _t1)
{
