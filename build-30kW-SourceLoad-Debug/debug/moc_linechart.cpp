...
QT_MOC_LITERAL(3, 24, 19), // "associateCompeleted"
QT_MOC_LITERAL(4, 44, 18) // "seriesColorChanged"

    },
    "LineChart\0tableChanged\0\0associateCompeleted\0"
    "seriesColorChanged"
};
...
void LineChart::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (LineChart::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LineChart::tableChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (LineChart::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LineChart::associateCompeleted)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (LineChart::*_t)(QColor , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LineChart::seriesColorChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void LineChart::tableChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void LineChart::associateCompeleted()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void LineChart::seriesColorChanged(QColor _t1, int _t2)
{
