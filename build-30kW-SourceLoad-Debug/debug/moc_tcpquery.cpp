/****************************************************************************
** Meta object code from reading C++ file 'tcpquery.h'
**
...
#error "The header file 'tcpquery.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 20, 8) // "TCPERROR"

    },
    "TcpQuery\0errorCode\0\0TCPERROR"
};
...
void TcpQuery::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->errorCode((*reinterpret_cast< TCPERROR(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (TcpQuery::*_t)(TCPERROR );
...
const QMetaObject TcpQuery::staticMetaObject = {
    { &Query::staticMetaObject, qt_meta_stringdata_TcpQuery.data,
...
// SIGNAL 0
void TcpQuery::errorCode(TCPERROR _t1)
{
